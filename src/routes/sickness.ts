...
export const declareSicknessRoutes = (router: Router) => {
  router.get('/sicknesses', authenticateUser, async (req: Request, res: Response) => {
    try {
  ...
  router.post('/sicknesses', authenticateUser, async (req: Request, res: Response) => {
    try {
  ...
  router.delete('/sicknesses/:id', authenticateUser, async (req: Request, res: Response) => {
    try {
  ...
  router.get('/sicknesses/:id/wellnessActivities', authenticateUser, async (req: Request, res: Response) => {
    try {
