...
export interface SicknessInstance
  extends Sequelize.Instance<SicknessAttributes>,
    SicknessAttributes {
  ...
  setSickPeople: Sequelize.BelongsToManySetAssociationsMixin<
    UserInstance,
    UserInstance['id'],
    'UserSicknesses'
  >;
  addSickPeople: Sequelize.BelongsToManyAddAssociationsMixin<
    UserInstance,
    UserInstance['id'],
    'UserSicknesses'
  >;
  addSickPerson: Sequelize.BelongsToManyAddAssociationMixin<
    UserInstance,
    UserInstance['id'],
    'UserSicknesses'
  >;
  createSickPeople: Sequelize.BelongsToManyCreateAssociationMixin<
    UserAttributes,
    UserInstance['id'],
    'UserSicknesses'
  >;
  removeSickPerson: Sequelize.BelongsToManyRemoveAssociationMixin<
    UserInstance,
    UserInstance['id']
  >;
  removeSickPeople: Sequelize.BelongsToManyRemoveAssociationsMixin<
    UserInstance,
    UserInstance['id']
  >;
  hasSickPerson: Sequelize.BelongsToManyHasAssociationMixin<
    UserInstance,
    UserInstance['id']
  >;
  hasSickPeople: Sequelize.BelongsToManyHasAssociationsMixin<
    UserInstance,
    UserInstance['id']
  >;
  countSickPeople: Sequelize.BelongsToManyCountAssociationsMixin;

  getWellnessActivities: Sequelize.BelongsToManyGetAssociationsMixin<
    WellnessActivityInstance
  >;
  setWellnessActivities: Sequelize.BelongsToManySetAssociationsMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id'],
    'SicknessWellnessActivities'
  >;
  addWellnessActivities: Sequelize.BelongsToManyAddAssociationsMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id'],
    'SicknessWellnessActivities'
  >;
  addWellnessActivity: Sequelize.BelongsToManyAddAssociationMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id'],
    'SicknessWellnessActivities'
  >;
  createWellnessActivities: Sequelize.BelongsToManyCreateAssociationMixin<
    WellnessActivityAttributes,
    WellnessActivityInstance['id'],
    'SicknessWellnessActivities'
  >;
  removeWellnessActivity: Sequelize.BelongsToManyRemoveAssociationMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id']
  >;
  removeWellnessActivities: Sequelize.BelongsToManyRemoveAssociationsMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id']
  >;
  hasWellnessActivity: Sequelize.BelongsToManyHasAssociationMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id']
  >;
  hasWellnessActivities: Sequelize.BelongsToManyHasAssociationsMixin<
    WellnessActivityInstance,
    WellnessActivityInstance['id']
  >;
